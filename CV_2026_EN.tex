...
\section{Professional Experiences}
   \resumeSubHeadingListStart
    \resumeSubheading
      {AI Scientist Intern}{February -- August 2026}
      {ALTEN}{Sèvres, France}
      \resumeItemListStart
        ...
        \resumeItem{Managed the end-to-end reserach pipeline, including formalizing the theoretical hypothesis, designing custom data ingestion for temporal graphs, and validating model robustness against historical system shocks.}
      \resumeItemListEnd
...
\resumeSubHeadingListStart
  ...
  \resumeSubheading
    {French Baccalauréat (Maths, Physics-Chemistry, Computer Science)}{2021}{}{}
  \vspace{-12pt}
...
\section{Projects}
  ...
  \resumeProjectHeading
      {\textbf{Hackathon Agentic Scenario organised by Reply Challenge}}{}
      \resumeItemListStart
      \resumeItem{Scenario : Built an agentic system to detect fraud case}
      \resumeItemListEnd 
